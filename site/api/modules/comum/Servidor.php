...
class Servidor {
	...
	const HTTP_REMOTO						= '192.168.0.2/pharmabook';
	...
	const BANCO_DADOS_REMOTO_URL			= '192.168.0.2';
	...
	const DIRETORIO_BASE_REMOTO				= '192.168.0.2/pharmabook/site/';

	const DIRETORIO_IMAGENS_LOCAL			= '/pharmabook/site/img/';
	const DIRETORIO_IMAGENS_REMOTO			= '192.168.0.2/pharmabook/site/img/';
