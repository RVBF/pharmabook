...
class Servidor {
	...
	const HTTP_LOCAL						= 'pharmabook.local';
	const HTTP_REMOTO						= '192.168.1.104/pharmabook';
	...
	const BANCO_DADOS_REMOTO_URL			= '192.168.1.104';
	...
	const DIRETORIO_BASE_LOCAL				= 'pharmabook.local/';
	const DIRETORIO_BASE_REMOTO				= '192.168.1.104/pharmabook/';

	const DIRETORIO_IMAGENS_LOCAL			= 'pharmabook.local/assets/img/';
	const DIRETORIO_IMAGENS_REMOTO			= '192.168.1.104/pharmabook/assets/img/';
