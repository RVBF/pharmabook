...
(function(window)
{
	...
	sistemaDePastas.css = 'assets/css/';
	...
	dependenciasJavaScript.push({ url :'https://maps.googleapis.com/maps/api/js?key=AIzaSyDKVTPUV1NmwiePNTATznH4GeXJHGUlOsk'});
