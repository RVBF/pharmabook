...
-- -----------------------------------------------------
-- Table `pharmabook`.`endereco_entidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pharmabook`.`endereco_entidade` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`farmacia` (
  ...
  `data_criacao` TIMESTAMP(6) NULL DEFAULT CURRENT_TIMESTAMP,
  `data_atualizacao` TIMESTAMP(6) NULL DEFAULT CURRENT_TIMESTAMP(6)	ON UPDATE CURRENT_TIMESTAMP,
  `endereco_entidade_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_farmacia_endereco_entidade1_idx` (`endereco_entidade_id` ASC),
  CONSTRAINT `fk_farmacia_endereco_entidade1`
    FOREIGN KEY (`endereco_entidade_id`)
    REFERENCES `pharmabook`.`endereco_entidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`usuario` (
  ...
  `endereco_entidade_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_usuario_endereco_entidade1_idx` (`endereco_entidade_id` ASC),
  CONSTRAINT `fk_usuario_endereco_entidade1`
    FOREIGN KEY (`endereco_entidade_id`)
    REFERENCES `pharmabook`.`endereco_entidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `pharmabook`.`forma_farmaceutica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pharmabook`.`forma_farmaceutica` (
  `id` INT NOT NULL,
  `nome` VARCHAR(255) NULL,
  `descricao` VARCHAR(255) NULL,
  `abreviacao` VARCHAR(255) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`medicamento` (
  ...
  INDEX `fk_medicamento_forma_farmaceutica1_idx` (`forma_farmaceutica_id` ASC),
  ...
  CONSTRAINT `fk_medicamento_laboratorio1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_medicamento_forma_farmaceutica1`
    FOREIGN KEY (`forma_farmaceutica_id`)
    REFERENCES `pharmabook`.`forma_farmaceutica` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`medicamento_pessoal` (
  ...
  `administracao` VARCHAR(20) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL,
...
-- -----------------------------------------------------
-- Table `pharmabook`.`notificacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pharmabook`.`notificacao` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `titulo` VARCHAR(255) NULL,
  `mensagem` VARCHAR(255) NULL,
  `usuario_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_notificacao_usuario2_idx` (`usuario_id` ASC),
