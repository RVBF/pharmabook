...
CREATE TABLE IF NOT EXISTS `pharmabook`.`medicamento_pessoal` (
  ...
  PRIMARY KEY (`id`, `medicamento_precificado_id`, `usuario_id`),
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`posologia` (
  ...
  `medicamento_pessoal_id` INT(11) NOT NULL,
  `medicamento_pessoal_medicamento_precificado_id` INT(11) NOT NULL,
  `medicamento_pessoal_usuario_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`, `medicamento_pessoal_id`, `medicamento_pessoal_medicamento_precificado_id`, `medicamento_pessoal_usuario_id`),
  INDEX `fk_posologia_medicamento_pessoal1_idx` (`medicamento_pessoal_id` ASC, `medicamento_pessoal_medicamento_precificado_id` ASC, `medicamento_pessoal_usuario_id` ASC),
  CONSTRAINT `fk_posologia_medicamento_pessoal1`
    FOREIGN KEY (`medicamento_pessoal_id` , `medicamento_pessoal_medicamento_precificado_id` , `medicamento_pessoal_usuario_id`)
    REFERENCES `pharmabook`.`medicamento_pessoal` (`id` , `medicamento_precificado_id` , `usuario_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
