...
CREATE TABLE IF NOT EXISTS `pharmabook`.`posologia` (
  ...
  `administracao` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`medicamento_precificado` (
  ...
  PRIMARY KEY (`id`, `farmacia_id`, `medicamento_id`, `usuario_id`, `posologia_id`),
  ...
  INDEX `fk_medicamento_precificado_posologia1_idx` (`posologia_id` ASC),
  ...
  CONSTRAINT `fk_medicamento_precificado_usuario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_medicamento_precificado_posologia1`
    FOREIGN KEY (`posologia_id`)
    REFERENCES `pharmabook`.`posologia` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`medicamento_pessoal` (
  ...
  `posologia_id` INT(11) NOT NULL,
  `usuario_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`, `medicamento_precificado_id`, `posologia_id`, `usuario_id`),
