...
CREATE TABLE IF NOT EXISTS `pharmabook`.`farmacia` (
  ...
  `dataCriacao` TIMESTAMP(6) NULL DEFAULT NULL,
  `dataAtualizacao` TIMESTAMP(6) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pharmabook`.`medicamento_pessoal` (
  ...
  `administracao` VARCHAR(20) NULL,
  `usuario_id` INT(11) NOT NULL,
  `medicamento_id` INT(11) NOT NULL,
  `data_criacao` TIMESTAMP(6) NULL DEFAULT CURRENT_TIMESTAMP,
  `data_atualizacao` TIMESTAMP(6) NULL ON UPDATE CURRENT_TIMESTAMP,
